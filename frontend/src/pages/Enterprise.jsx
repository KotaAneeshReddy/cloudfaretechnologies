...
import { Shield, Zap, Cpu, BarChart, ArrowRight, Sparkles, Server, Globe } from 'lucide-react';
      ...
      <section className="section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <ServiceCard 
            ...
            desc="End-to-end development of high-availability web and mobile ecosystems."
            delay={0.1}
          />
          <ServiceCard 
            icon={<Zap className="text-accent-purple" />}
            title="AI Integration"
            desc="Hyper-scaling business intelligence through custom LLMs and Automation."
            delay={0.2}
          />
          <ServiceCard 
            icon={<Shield className="text-emerald-500" />}
            title="Cyber Security"
            desc="Zero-trust architecture and global cloud security compliance frameworks."
            delay={0.3}
          />
          <ServiceCard 
            icon={<BarChart className="text-amber-500" />}
            title="Data Intelligence"
            desc="Enterprise data lakes and predictive analytics for market dominance."
            delay={0.4}
          />
        </div>
        ...
        <div className="mt-40 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div>
                ...
                <button className="mt-12 btn-primary !px-10 !py-4 group">
